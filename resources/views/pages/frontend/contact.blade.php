...
@section('content')
    ...
    <section class="pt_120 pb_90 bg_gray10">
        <div class="auto-container">  
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="">
                        <form class="contact_form" action="mail.php" method="post" data-aos="fade-left" autocomplete="off" data-aos-duration="1000">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <input type="text" name="mobile" class="form-control" value="" placeholder="Phone Number *" required="">
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <button class="btn-1 text-center pt_12 pb_9 pl_30 pr_30 b_radius_5 ff_sec fw_bold tt_u fs_14 ls_1" type="submit" value="Send Mail" name="submit">Send Mail<span></span></button>
                                </div>
                            </div>
                        </form>
                    </div>
	...
	<!-- map -->
    <div class="map">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.323687281428!2d78.69616270998624!3d10.786501989318516!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3baaf522449c4b13%3A0x9682228f66a04612!2sSTHREE%20ENGINEERS!5e0!3m2!1sen!2sin!4v1690825305818!5m2!1sen!2sin" width="600" height="535" frameborder="0" style="border:0; width: 100%" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
    </div>
