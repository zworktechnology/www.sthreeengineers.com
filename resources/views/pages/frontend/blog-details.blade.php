                        ...
                        <ul>
                            ...
                            <div>
                                <ul class="footer-social-media mt_70">
                                    ...
                                    <li><a class="hvr-zoom-1 hvr-zoom-1-primary"
                                            href="https://www.linkedin.com/company/sthree-engineering/"
                                            target="_blank">
                ...
                <div class="auto-container">
                    <div class="p_relative text-center">
                        <h1 class="c_light mb_10 fw_black fs_65 wow fadeInUp" data-wow-delay=".2s"
                            data-wow-duration="1.5s">Blog Details</h1>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="link-widget-1 mb_40">
                                ...
                                <ul class="link-widget-1-list c_light2 fw_medium">
                                    ...
                                    <li><a href="{{ route('project_management') }}">Project Management (PMC)</a>
                                    </li>
                                    <li><a href="{{ route('valuation') }}">Valuation</a></li>
                                    <li><a href="{{ route('survey') }}">Surveying</a></li>
                                </ul>
