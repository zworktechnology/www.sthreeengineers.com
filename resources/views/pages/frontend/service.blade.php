...
@section('content')
	...
	<section class="pb_110 pt_100">
	    <div class="auto-container">
	        <h6 class="theme-color ff_sec fw_bold tt_u fs_14 ls_1 mb_15"><span class="w_30 h_2 theme-bg mr_10 d_iblock v_middle"></span>Services</h6>
	        <h2 class="fw_black fs_45 mb_20">What we do</h2>
	        <p class="mb_50 fs_18">
	            Besides providing civil engineering services, we also provide
	            contractor service for building renovation, Interior works like modual kitchen and other. Dectrative works as well as extensive range of building
	        ...
	        <div class="row">
	            ...
	            <div class="col-lg-4 col-md-6 wow fadeInDown" data-wow-delay=".2s" data-wow-duration="1.5s">
	                <div class="service-1-block alt">
	                    ...
	                    <div class="service-1-image">
	                        <img src="{{ asset('assets/frontend/images/resource/13.jpg') }} " alt="building construction, valuation, approval, surveyor, builder near me, building contractor, e valuation, builders in trichy, construction company in trichy">
	            ...
	            <div class="col-lg-4 col-md-6 wow fadeInDown" data-wow-delay=".2s" data-wow-duration="1.5s">
	                <div class="service-1-block alt">
	                    ...
	                    <div class="service-1-image">
	                        <img src="{{ asset('assets/frontend/images/resource/2.jpg') }}" alt="building construction, valuation, approval, surveyor, builder near me, building contractor, e valuation, builders in trichy, construction company in trichy, interior designer in trichy">
