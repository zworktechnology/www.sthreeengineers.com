...
<section class="banner-1-section pt_240 pb_140 bg_cover overflow-hidden"
    ...
    <div class="auto-container">
        <div class="p_relative text-center">
            <h1 class="c_light mb_10 fw_black fs_65 wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">Project
                Management</h1>
                ...
                <div class="service-1-block alt">
                    ...
                    <div class="service-1-image">
                        ...
                        <div class="service-1-read-more"><a href="javascript:void(0);"
                                ...
                                Efficiently plan, execute, and oversee construction projects with our comprehensive
                                civil project management services.
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                <div class="service-1-block alt">
                    ...
                    <div class="service-1-image">
                        ...
                        <div class="service-1-read-more"><a href="javascript:void(0);"
                                class="c_light ff_sec fw_bold fs_14 ls_1">
                                Streamline your project with comprehensive documentation services. Organized records for
                                smooth operations.
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInDown" data-wow-delay=".2s" data-wow-duration="1.5s">
                <div class="service-1-block alt">
                    ...
                    <div class="service-1-image">
                        ...
                        <div class="service-1-read-more"><a href="javascript:void(0);"
                                class="c_light ff_sec fw_bold fs_14 ls_1">
                                Accurate BOQs prepared to detail. Ensuring transparency and precision in project cost
                                estimation.
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                <div class="service-1-block alt">
                    ...
                    <div class="service-1-image">
                        ...
                        <div class="service-1-read-more"><a href="javascript:void(0);"
                                class="c_light ff_sec fw_bold fs_14 ls_1">
                                Trust us for accurate bill certification services. Ensuring fair and transparent
            ...
            <div class="col-lg-4 col-md-6 wow fadeInDown" data-wow-delay=".2s" data-wow-duration="1.5s">
                <div class="service-1-block alt">
                    ...
                    <div class="service-1-image">
                        ...
                        <div class="service-1-read-more"><a href="javascript:void(0);"
                                class="c_light ff_sec fw_bold fs_14 ls_1">
                                Keep costs in check with our meticulous cost management strategies. Maximizing value for
                                your investments.
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                <div class="service-1-block alt">
                    ...
                    <div class="service-1-image">
                        ...
                        <div class="service-1-read-more"><a href="javascript:void(0);"
                                class="c_light ff_sec fw_bold fs_14 ls_1">
                                In-depth rate analysis for informed decision-making. Achieve cost-effective project
                                outcomes.
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInDown" data-wow-delay=".2s" data-wow-duration="1.5s">
                <div class="service-1-block alt">
                    ...
                    <div class="service-1-image">
                        ...
                        <div class="service-1-read-more"><a href="javascript:void(0);"
                                class="c_light ff_sec fw_bold fs_14 ls_1">
                                Rigorous audits for quality and cost-effectiveness. Continuous improvement for project
                                excellence.
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInDown" data-wow-delay=".2s" data-wow-duration="1.5s">
                <div class="service-1-block alt">
                    ...
                    <div class="service-1-image">
                        ...
                        <div class="service-1-read-more"><a href="javascript:void(0);"
                                class="c_light ff_sec fw_bold fs_14 ls_1">
                                Consult with our experts for project success. Invaluable insights and guidance
