                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                        <div class="service-1-block alt">
                            ...
                            <div class="service-1-image">
                                <img src="{{ asset('assets/frontend/images/resource/Approval/1.jpg') }}"
                                    alt="building construction, valuation, approval, surveyor, builder near me, building contractor, e valuation, builders in trichy, construction company in trichy">
                                <div class="service-1-read-more"><a href="javascript:void(0);"
                                        class="c_light ff_sec fw_bold fs_14 ls_1">
                                        Secure DTCP (Directorate of Town and Country Planning) approval for your
                                        land. Comply with urban planning regulations seamlessly.
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInDown" data-wow-delay=".2s" data-wow-duration="1.5s">
                        <div class="service-1-block alt">
                            ...
                            <div class="service-1-image">
                                <img src="{{ asset('assets/frontend/images/resource/Approval/2.jpg') }}"
                                    alt="building construction, valuation, approval, surveyor, builder near me, building contractor, e valuation, builders in trichy, construction company in trichy">
                                <div class="service-1-read-more"><a href="javascript:void(0);"
                                        class="c_light ff_sec fw_bold fs_14 ls_1">
                                        Obtain necessary approvals for your construction project. Ensure compliance
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInDown" data-wow-delay=".2s" data-wow-duration="1.5s">
                        <div class="service-1-block alt">
                            ...
                            <div class="service-1-image">
                                <img src="{{ asset('assets/frontend/images/resource/Approval/3.jpg') }}"
                                    alt="building construction, valuation, approval, surveyor, builder near me, building contractor, e valuation, builders in trichy, construction company in trichy">
                                <div class="service-1-read-more"><a href="javascript:void(0);"
                                        class="c_light ff_sec fw_bold fs_14 ls_1">
                                        Simplify the land registration process with our expert guidance. Ensure
                                        legal ownership and smooth property transactions.
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInDown" data-wow-delay=".2s" data-wow-duration="1.5s">
                        <div class="service-1-block alt">
                            ...
                            <div class="service-1-image">
                                <img src="{{ asset('assets/frontend/images/resource/Approval/4.jpg') }}"
                                    alt="building construction, valuation, approval, surveyor, builder near me, building contractor, e valuation, builders in trichy, construction company in trichy">
                                <div class="service-1-read-more"><a href="javascript:void(0);"
                                        class="c_light ff_sec fw_bold fs_14 ls_1">
                                        Register your constructed building with ease. We facilitate the registration
    ...
    <script type="application/ld+json">
      {
            ...
            "name": "Building Approval Services",
            "description": "Efficient building approval and sanction services for a hassle-free construction process.",
            "url": "https://www.sthreeengineers.com/approval",
            ...
            "breadcrumb": {
                ...
                {"@type": "ListItem", "position": 3, "name": "Approval"}
                ]
            }
        }
