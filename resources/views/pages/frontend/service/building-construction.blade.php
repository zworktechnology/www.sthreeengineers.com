                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                        <div class="service-1-block alt">
                            ...
                            <div class="service-1-image">
                                <img src="{{asset('assets/frontend/images/resource/Building_Construction/1.jpg')}}"
                                    alt="building construction, valuation, approval, surveyor, builder near me, building contractor, e valuation, builders in trichy, construction company in trichy">
                                <div class="service-1-read-more"><a href="javascript:void(0);"
                                        class="c_light ff_sec fw_bold fs_14 ls_1">
                                        Create your dream home with our expert residential building services.
                                        Quality craftsmanship and tailored designs.
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInDown" data-wow-delay=".2s" data-wow-duration="1.5s">
                        <div class="service-1-block alt">
                            ...
                            <div class="service-1-image">
                                <img src="{{asset('assets/frontend/images/resource/Building_Construction/2.jpg')}}"
                                    alt="building construction, valuation, approval, surveyor, builder near me, building contractor, e valuation, builders in trichy, construction company in trichy">
                                <div class="service-1-read-more"><a href="javascript:void(0);"
                                        class="c_light ff_sec fw_bold fs_14 ls_1">
                                        Elevate your business with our commercial building solutions. Functional
                                        spaces designed for success.
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                        <div class="service-1-block alt">
                            ...
                            <div class="service-1-image">
                                <img src="{{asset('assets/frontend/images/resource/Building_Construction/3.jpg')}}"
                                    alt="building construction, valuation, approval, surveyor, builder near me, building contractor, e valuation, builders in trichy, construction company in trichy">
                                <div class="service-1-read-more"><a href="javascript:void(0);"
                                        class="c_light ff_sec fw_bold fs_14 ls_1">
                                        Efficiency meets innovation in our industrial building projects.
                                        Constructing the foundation for your industry.
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInDown" data-wow-delay=".2s" data-wow-duration="1.5s">
                        <div class="service-1-block alt">
                            ...
                            <div class="service-1-image">
                                <img src="{{asset('assets/frontend/images/resource/Building_Construction/5.jpg')}}"
                                    alt="building construction, valuation, approval, surveyor, builder near me, building contractor, e valuation, builders in trichy, construction company in trichy">
                                <div class="service-1-read-more"><a href="javascript:void(0);"
                                        class="c_light ff_sec fw_bold fs_14 ls_1">
                                        Institutional Buildings Service: Expert solutions for planning, designing,
                                        and maintaining functional, safe, and sustainable public structures.
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInDown" data-wow-delay=".2s" data-wow-duration="1.5s">
                        <div class="service-1-block alt">
                            ...
                            <div class="service-1-image">
                                <img src="{{asset('assets/frontend/images/resource/Building_Construction/4.jpg')}}"
                                    alt="building construction, valuation, approval, surveyor, builder near me, building contractor, e valuation, builders in trichy, construction company in trichy">
                                <div class="service-1-read-more"><a href="javascript:void(0);"
                                        class="c_light ff_sec fw_bold fs_14 ls_1">
                                        Sacred spaces crafted with reverence. Trust us to build your place of
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInDown" data-wow-delay=".2s" data-wow-duration="1.5s">
                        <div class="service-1-block alt">
                            ...
                            <div class="service-1-image">
                                <img src="{{asset('assets/frontend/images/resource/Building_Construction/6.jpg')}}"
                                    alt="building construction, valuation, approval, surveyor, builder near me, building contractor, e valuation, builders in trichy, construction company in trichy">
                                <div class="service-1-read-more"><a href="javascript:void(0);"
                                        class="c_light ff_sec fw_bold fs_14 ls_1">
                                        Roads and bridges: vital infrastructure connecting communities, enabling
                                        travel, and fostering economic growth and development.
                                    </a>
                                </div>
                            </div>
                        </div>
