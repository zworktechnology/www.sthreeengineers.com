...
<head>
    ...
    <meta name="description"
        content="Transforming Trichy's skyline, one project at a time. Our civil project and management company handles every detail, so you can focus on the dream.">
    <meta name="keywords"
        content="pmc company, civil project and management company in trichy, construction industry project management">
    ...
    <meta property="og:description"
        content="From complex plans to soaring structures, our civil engineering experts manage every detail. Your project, our dedication - together, we build the future.">
    <meta property="og:image" content="https://www.sthreeengineers.com/assets/frontend/images/gallery/gallery-6.webp"
        alt="construction industry project management">
                ...
                <div class="sec-title-area mb_10">
                    <div class="row ">
                        <p class="mb_30">
                            ...
                            in Trichy.
                            With our expertise in construction <a href="{{ route('project_management') }}"
