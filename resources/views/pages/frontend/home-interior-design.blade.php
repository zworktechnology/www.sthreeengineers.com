...
<head>
    ...
    <meta name="description"
        content="Feeling stuck in a space that doesn't reflect you? A home interior designer unlocks your dream home's potential. Let's create a heaven you love.">
    <meta name="keywords"
        content="interior works, home interior designer, interior design, interior design work, interior designer">
    ...
    <meta property="og:description"
        content="Is your home yearning for a refresh? A home interior designer can be your magic wand, transforming your space into a heaven that speaks to your soul.">
                ...
                <div class="sec-title-area mb_10">
                    <div class="row ">
                        <p class="mb_30">
                            ...
                            As your dedicated home <a href="{{ route('interior') }}" style="color: blue"> interior
