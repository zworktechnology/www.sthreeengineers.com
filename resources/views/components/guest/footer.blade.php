                ...
                <div class="col-lg-4 col-md-6">
                    <div class="contact-info-box2 d-flex align-items-start ps-lg-5 pt_20 pb_15">
                        ...
                        <p class="c_light mb_0 fs_20 lh_30">Call us on : <br> <a class="fs_22 fw_medium"
                                href="tel:+917871313987">(+91) 78713 13987</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="footer-1-middle pt_60 bg_dark8">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="about-widget mb_40">
                        ...
                        <ul class="footer-social-media mt_70">
                            <li><a class="hvr-zoom-1 hvr-zoom-1-primary" href="https://www.facebook.com/sthreeengineers"
                                    target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                            <li><a class="hvr-zoom-1 hvr-zoom-1-primary"
                                    href="https://www.linkedin.com/company/sthree-engineering/" target="_blank"><i
                                        class="fab fa-linkedin-in"></i></a></li>
                            <li><a class="hvr-zoom-1 hvr-zoom-1-primary"
                                    href="https://www.instagram.com/sthreeengineers" target="_blank"><i
                                        class="fab fa-instagram"></i></a></li>
                            <li><a class="hvr-zoom-1 hvr-zoom-1-primary"
                                    href="https://www.youtube.com/@sthreeengineers2143" target="_blank"><i
        ...
        <div class="auto-container">
            ...
            <div class="d-flex justify-content-lg-between pt_20 pb_6">
                <p class="c_light2 fs_17 mb_20 fw_medium">© Copyright 2023 <a href="https://www.zworktechnology.com/"
                        target="_blank">Zwork Technology</a> 2023. All right reserved. </p>
                <p class="c_light2 fs_17 mb_20 fw_medium">Terms & Conditions</p>
            </div>
        </div>
    </div>
</footer>
